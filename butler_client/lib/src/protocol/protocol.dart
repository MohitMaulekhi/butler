...
import 'tasks/task.dart' as _i5;
import 'package:butler_client/src/protocol/calendar/calendar_event.dart' as _i6;
import 'package:butler_client/src/protocol/chat/chat_message.dart' as _i7;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == List<_i6.CalendarEvent>) {
      return (data as List)
              .map((e) => deserialize<_i6.CalendarEvent>(e))
              .toList()
          as T;
    }
