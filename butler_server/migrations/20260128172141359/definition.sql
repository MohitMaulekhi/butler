...
--
-- Class GoogleCalendarConnection as table google_calendar_connection
--
...
--
-- Class UserMemory as table user_memory
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('butler', '20260128172141359', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260128172141359', "timestamp" = now();
